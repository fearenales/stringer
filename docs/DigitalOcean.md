...
After you run Stringer locally using [`Run Project` button](https://github.com/run-project/stringer#using-azk), deploying to [DigitalOcean](http://digitalocean.com/) is very simple.
